...
public class NoParMethodDeclaration extends MethodDecl {

    private MethodTypeNamePair MethodTypeNamePair;
    private VarDecls VarDecls;
    private Statements Statements;

    public NoParMethodDeclaration (MethodTypeNamePair MethodTypeNamePair, VarDecls VarDecls, Statements Statements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NoParMethodDeclaration(\n");
