...
public class NoMethodClassDeclaration extends ClassDecl {

    private String I1;
    private VarDecls VarDecls;

    public NoMethodClassDeclaration (String I1, VarDecls VarDecls) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NoMethodClassDeclaration(\n");
