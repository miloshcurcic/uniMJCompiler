...
public class ExtendedClassDecl extends ClassDecl {
    ...
    public ExtendedClassDecl (String I1, Type Type, VarDecls VarDecls, MethodDecls MethodDecls) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExtendedClassDecl(\n");
