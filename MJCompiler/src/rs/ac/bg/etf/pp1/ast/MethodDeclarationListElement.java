...
public class MethodDeclarationListElement extends MethodDecls {

    private MethodDecls MethodDecls;
    private MethodDecl MethodDecl;

    public MethodDeclarationListElement (MethodDecls MethodDecls, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclarationListElement(\n");
