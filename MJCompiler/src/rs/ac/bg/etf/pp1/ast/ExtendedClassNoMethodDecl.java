...
public class ExtendedClassNoMethodDecl extends ClassDecl {

    private String I1;
    private Type Type;
    private VarDecls VarDecls;

    public ExtendedClassNoMethodDecl (String I1, Type Type, VarDecls VarDecls) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExtendedClassNoMethodDecl(\n");
