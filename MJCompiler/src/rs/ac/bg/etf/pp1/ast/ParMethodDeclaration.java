...
public class ParMethodDeclaration extends MethodDecl {
    ...
    public ParMethodDeclaration (MethodTypeNamePair MethodTypeNamePair, FormPars FormPars, VarDecls VarDecls, Statements Statements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ParMethodDeclaration(\n");
