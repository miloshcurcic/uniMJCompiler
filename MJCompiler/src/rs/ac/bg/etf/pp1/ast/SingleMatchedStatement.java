...
public class SingleMatchedStatement extends SingleStatement {

    private MatchedStatement MatchedStatement;

    public SingleMatchedStatement (MatchedStatement MatchedStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleMatchedStatement(\n");
