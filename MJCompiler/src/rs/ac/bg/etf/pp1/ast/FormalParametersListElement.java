...
public class FormalParametersListElement extends FormPars {

    private FormPars FormPars;
    private FormPar FormPar;

    public FormalParametersListElement (FormPars FormPars, FormPar FormPar) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParametersListElement(\n");
